...
2 модель решили не встраивать, потому что время работы приложения еще увеличится. В FAISS эмбеддинги 2 модели быстро закинуть не получилось,
поэтому остановились на начальном варианте с 1 моделью. 
