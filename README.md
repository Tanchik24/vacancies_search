...
Масштабируемость: работа на миллионах данных за приемлемое время возможна, так как используется FAISS и при добавлении резюме/вакансий мы просто пересчитываем эмбеддинги, то есть скорость поиска почти не увеличится.
